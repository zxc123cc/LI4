...
def create_dataloaders(args,tokenizer):
    train_dataset = ColloquialDataset(args,args.train_file,tokenizer)
    val_dataset = ColloquialDataset(args,args.dev_file,tokenizer)
...
class ColloquialDataset(Dataset):
    def __init__(self, args, file_path,tokenizer) -> object:
    ...
    def __getitem__(self, idx: int):
        ...
        prefix = 'Determine whether the claim is supported, refuted, or neutral by the given question and evidence.'
